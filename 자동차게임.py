...
def runGame():
    bomb_image = pygame.image.load('images/bomb.jpg')
    bomb_image = pygame.transform.scale(bomb_image, (125, 215))
    bombs = []
    ...
    for i in range(5):
        ...
        rect.top = -100
        dy = random.randint(8, 14)
        bombs.append({'rect': rect, 'dy': dy})

    person_image = pygame.image.load('images/person.png')
    person_image = pygame.transform.scale(person_image, (125, 215))
